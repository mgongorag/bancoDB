    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        try {
            if (usuarioDB.existeCuenta(numCuenta)) {
                cuenta = usuarioDB.buscarCuenta(numCuenta);
                lblNombreCuenta.setText(cuenta.getUser().getNombre() + " " + cuenta.getUser().getApellido());
                lblEfectivo.setText(String.valueOf(cuenta.getSaldo()));
                lblDolares.setText(utilidad.convertirDolares(cuenta.getSaldo()));
                ...
                JOptionPane.showMessageDialog(null, "Esta cuenta no existe", "BancoUMG", JOptionPane.ERROR_MESSAGE);
                limpiar(1);
            }
        } catch (SQLException e) {
            JOptionPane.showMessageDialog(null, "Ha ocurrido un error en la busqueda\n"
                    + "Intente nuevamente.\n"
                    + "Si el problema persiste contacte a soporte tecnico", "BancoUMG", JOptionPane.ERROR_MESSAGE);
            limpiar(1);
        }
